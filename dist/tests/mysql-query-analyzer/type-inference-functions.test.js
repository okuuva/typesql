...
describe('type-inference - functions', () => {
    ...
    it('SELECT YEAR(CURTIME())', () => {
        ...
        try {
            (0, parse_1.parseAndInfer)(sql, create_schema_1.dbSchema);
            node_assert_1.default.fail('Should throw an exception');
        }
        catch (e) {
            const expectedMessage = 'Type mismatch: time and date';
            node_assert_1.default.deepStrictEqual(e.message, expectedMessage);
        }
    });
    ...
    it(`SELECT HOUR('2017-06-20')`, () => {
        ...
        try {
            (0, parse_1.parseAndInfer)(sql, create_schema_1.dbSchema);
            node_assert_1.default.fail('Should throw an exception'); //Only DATE and DATETIME are allowed
        }
        catch (e) {
    ...
    it('INTERVAL expression with invalid date', () => {
        ...
        try {
            (0, parse_1.parseAndInfer)(sql, create_schema_1.dbSchema);
            node_assert_1.default.fail('Should thrown an exception.');
        }
        catch (e) {
            const expected = 'Type mismatch: varchar and datetime';
            node_assert_1.default.deepStrictEqual(e.message, expected);
        }
    });
...
//# sourceMappingURL=type-inference-functions.test.js.map