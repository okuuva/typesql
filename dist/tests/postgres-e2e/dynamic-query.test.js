...
describe('e2e-postgres-dynamic-query', () => {
    ...
    it('dynamicQuery01 - without filters', () => __awaiter(void 0, void 0, void 0, function* () {
        const result = yield (0, sql_1.dynamicQuery01)(pool);
    ...
    it('dynamicQuery01 - select columns', () => __awaiter(void 0, void 0, void 0, function* () {
        const result = yield (0, sql_1.dynamicQuery01)(pool, {
            select: {
                id: true,
                name: true
    ...
    it('dynamicQuery01 - where BETWEEN', () => __awaiter(void 0, void 0, void 0, function* () {
        const result = yield (0, sql_1.dynamicQuery01)(pool, {
            select: {
                id: true,
                name: true
    ...
    it('dynamicQuery01 - IN', () => __awaiter(void 0, void 0, void 0, function* () {
        const result = yield (0, sql_1.dynamicQuery01)(pool, {
            select: {
                id: true,
                name: true
    ...
    it('dynamicQuery01 - NOT IN', () => __awaiter(void 0, void 0, void 0, function* () {
        const result = yield (0, sql_1.dynamicQuery01)(pool, {
            select: {
                id: true,
                name: true
    ...
    it('dynamicQuery01 - >= and <=', () => __awaiter(void 0, void 0, void 0, function* () {
        const result = yield (0, sql_1.dynamicQuery01)(pool, {
            select: {
                id: true,
                name: true
    ...
    it('dynamic-query02 - derivated-table', () => __awaiter(void 0, void 0, void 0, function* () {
        const result = yield (0, sql_1.dynamicQuery02)(pool, {
            params: {
                subqueryName: 'two'
            }
        });
    ...
    it('dynamic-query-03', () => __awaiter(void 0, void 0, void 0, function* () {
        const result = yield (0, sql_1.dynamicQuery03)(pool, {
            select: {
                value: true
            },
            where: [
    ...
    it('dynamic-query-04 - LIKE o%', () => __awaiter(void 0, void 0, void 0, function* () {
        const result = yield (0, sql_1.dynamicQuery04)(pool, {
            select: {
                value: true,
                name: true
            },
    ...
    it('dynamic-query-05 - cte', () => __awaiter(void 0, void 0, void 0, function* () {
        const result = yield (0, sql_1.dynamicQuery05)(pool, {
            select: {
                id: true,
                name: true
            },
    ...
    it('dynamic-query-05 - exclude CTE', () => __awaiter(void 0, void 0, void 0, function* () {
        const result = yield (0, sql_1.dynamicQuery05)(pool, {
            select: {
                id: true
            },
    ...
    it('dynamic-query-08 - date', () => __awaiter(void 0, void 0, void 0, function* () {
        const result = yield (0, sql_1.dynamicQuery08)(pool, {
            params: {
                param1: 2024,
                param2: 12
            }
    ...
    it('dynamic-query-08 - date >= new Date(2025, 0, 2)', () => __awaiter(void 0, void 0, void 0, function* () {
        const result = yield (0, sql_1.dynamicQuery08)(pool, {
            params: {
                param1: 2025,
                param2: 1
    ...
    it('dynamic-query-10 - limit and offset', () => __awaiter(void 0, void 0, void 0, function* () {
        const result = yield (0, sql_1.dynamicQuery10)(pool, {
            params: {
                name: 'two',
                limit: '2',
                offset: '0'
