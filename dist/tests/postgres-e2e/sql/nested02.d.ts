...
export declare function nested02(client: pg.Client | pg.Pool | pg.PoolClient): Promise<Nested02Result[]>;
export declare function nested02Nested(client: pg.Client | pg.Pool | pg.PoolClient): Promise<Nested02NestedUsers[]>;
