...
exports.dynamicQuery04 = dynamicQuery04;
...
function dynamicQuery04(client, params) {
    return __awaiter(this, void 0, void 0, function* () {
        const { sql, paramsValues } = buildSql(params);
        return client.query({ text: sql, rowMode: 'array', values: paramsValues })
            .then(res => res.rows.map(row => mapArrayToDynamicQuery04Result(row, params === null || params === void 0 ? void 0 : params.select)));
    });
}
...
function mapArrayToDynamicQuery04Result(data, select) {
    const result = {};
    let rowIndex = -1;
    if (!select || select.id === true) {
        rowIndex++;
...
//# sourceMappingURL=dynamic-query04.js.map