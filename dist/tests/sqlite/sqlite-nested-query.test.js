...
describe('sqlite-nested-query', () => {
    ...
    it('SELECT FROM users u INNER JOIN posts p', () => {
        ...
        node_assert_1.default.deepStrictEqual(actual.right.nestedInfo, expectedModel);
    });
    ...
    it('many to many - chinook (without join table)', () => {
        ...
        const chinookDb = new better_sqlite3_1.default('./mydb.db');
        const dbSchema = (0, query_executor_1.loadDbSchema)(chinookDb);
        if (dbSchema.isErr()) {
            node_assert_1.default.fail(`Shouldn't return an error: ${dbSchema.error.description}`);
        }
        const actual = (0, parser_1.parseSql)(sql, dbSchema.value);
        if ((0, Either_1.isLeft)(actual)) {
            node_assert_1.default.fail(`Shouldn't return an error: ${actual.left.description}`);
        }
        node_assert_1.default.deepStrictEqual(actual.right.nestedInfo, expectedModel);
...
INNER JOIN mytable2 t2 on t2.id = t1.id `;
        ...
        node_assert_1.default.deepStrictEqual(actual.left, expectedError);
    });
...
//# sourceMappingURL=sqlite-nested-query.test.js.map