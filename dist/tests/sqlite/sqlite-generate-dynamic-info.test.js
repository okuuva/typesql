...
describe('sqlite-generate-dynamic-info', () => {
    it('dynamic-traverse-result-01', () => {
        ...
        const actual = (0, parser_1.traverseSql)(sql, create_schema_1.sqliteDbSchema);
        const expected = {
            with: [],
            select: [
                {
        ...
        (0, node_assert_1.default)(actual.right.traverseResult.queryType === 'Select');
        node_assert_1.default.deepStrictEqual(actual.right.traverseResult.dynamicQueryInfo, expected);
    });
    it('dynamic-info-result01', () => {
        ...
        node_assert_1.default.deepStrictEqual(actual.right.dynamicSqlQuery2, expected);
    });
...
//# sourceMappingURL=sqlite-generate-dynamic-info.test.js.map