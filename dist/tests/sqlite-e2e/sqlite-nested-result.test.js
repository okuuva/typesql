...
describe('sqlite-nested-result', () => {
    ...
    it('nested02 - users -> posts -> roles -> comments', () => {
        const result = (0, sql_1.nested02Nested)(db);
        const expectedResult = [
            {
                user_id: 1,
                user_name: 'user1',
    ...
    it('nested03 - client1', () => {
        const result = (0, sql_1.nested03Nested)(db, {
            param1: 1
        });
        const expectedResult = [
            {
    ...
    it('nested04 - surveys -> participants -> users (with join table)', () => {
        const result = (0, sql_1.nested04Nested)(db);
        const expectedResult = [
            {
                surveyId: 1,
                surveyName: 's1',
    ...
    it('nested04 - surveys -> participants -> users (without join table)', () => {
        const result = (0, sql_1.nested04WithoutJoinTableNested)(db);
        const expectedResult = [
            {
                id: 1,
                name: 's1',
...
//# sourceMappingURL=sqlite-nested-result.test.js.map