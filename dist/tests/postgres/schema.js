...
exports.userFunctions = exports.checkConstraints = exports.enumMap = exports.userDefinedFunctions = exports.schema = void 0;
exports.createSchemaInfo = createSchemaInfo;
exports.createTestClient = createTestClient;
exports.normalizeUserFunctions = normalizeUserFunctions;
...
exports.enumMap.set(16651, enumValues);
...
function createSchemaInfo() {
    const schemaInfo = {
        kind: 'pg',
        columns: exports.schema,
        foreignKeys: [],
        userFunctions: exports.userFunctions,
        enumTypes: exports.enumMap,
        checkConstraints: exports.checkConstraints
    };
    return schemaInfo;
}
...
function normalizeUserFunctions(userFunctions) {
    const normalized = userFunctions.map(r => (Object.assign(Object.assign({}, r), { definition: normalizeNewlines(r.definition) })));
    return normalized;
}
