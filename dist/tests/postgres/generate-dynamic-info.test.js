...
describe('postgres-generate-dynamic-info', () => {
    const databaseClient = (0, schema_1.createTestClient)();
    ...
    it('dynamic-traverse-result-01', () => {
        ...
        const actual = (0, parser_1.parseSql)(sql, schema_1.schema, {}, [], { collectDynamicQueryInfo: true });
        const expected = {
            with: [],
            select: [
                {
        ...
        node_assert_1.default.deepStrictEqual(actual.dynamicQueryInfo, expected);
    });
    it('dynamic-info-result01', () => __awaiter(void 0, void 0, void 0, function* () {
        const sql = `-- @dynamicQuery
		SELECT m1.id, m1.value, m2.name, m2.descr as description
		FROM mytable1 m1
		INNER JOIN mytable2 m2 on m1.id = m2.id`;
        const actual = yield (0, describe_1.describeQuery)(databaseClient, sql, schemaInfo);
        const expected = {
            with: [],
            select: [
                {
        ...
        node_assert_1.default.deepStrictEqual(actual.value.dynamicSqlQuery2, expected);
    }));
    ...
    it('dynamic-info-result02', () => __awaiter(void 0, void 0, void 0, function* () {
        const sql = `-- @dynamicQuery
		SELECT m1.id, m2.name
		FROM mytable1 m1
		INNER JOIN ( -- derivated table
    ...
    it('dynamic-info-result02-with-where', () => __awaiter(void 0, void 0, void 0, function* () {
        const sql = `-- @dynamicQuery
		SELECT m1.id, m2.name
		FROM mytable1 m1
		INNER JOIN ( -- derivated table
    ...
    it('dynamic-info-result05', () => __awaiter(void 0, void 0, void 0, function* () {
        const sql = `-- @dynamicQuery
		WITH
			cte as (
				select id, name from mytable2
    ...
    it('dynamic-info-result05-with-where', () => __awaiter(void 0, void 0, void 0, function* () {
        const sql = `-- @dynamicQuery
		WITH
			cte as (
				select id, name from mytable2
    ...
    it('dynamic-info-result06', () => __awaiter(void 0, void 0, void 0, function* () {
        const sql = `-- @dynamicQuery
		SELECT m1.*, m3.*
		FROM mytable1 m1
		INNER JOIN mytable2 m2 on m2.id = m1.id
    ...
    it('dynamic-info-result06-with-where', () => __awaiter(void 0, void 0, void 0, function* () {
        const sql = `-- @dynamicQuery
		select t2.name, t3.name as name2
		from mytable2 t2
		inner join mytable3 t3 on t3.id = t2.id
    ...
    it('dynamic-info-result: where t3.id > 1', () => __awaiter(void 0, void 0, void 0, function* () {
        const sql = `-- @dynamicQuery
		select t2.name, t3.name as name2
		from mytable2 t2
		inner join mytable3 t3 on t3.id = t2.id
    ...
    it('dynamic-info-result: SELECT with parameters', () => __awaiter(void 0, void 0, void 0, function* () {
        const sql = `-- @dynamicQuery
		SELECT
			t2.id,
			t3.double_value,
    ...
    it('dynamic-info-result11', () => __awaiter(void 0, void 0, void 0, function* () {
        const sql = `-- @dynamicQuery
		WITH
			cte1 as (
				select id, value from mytable1
    ...
    it('dynamic-info-result12', () => __awaiter(void 0, void 0, void 0, function* () {
        const sql = `-- @dynamicQuery
		WITH
			cte1 as (
				select id, value from mytable1
...
//# sourceMappingURL=generate-dynamic-info.test.js.map